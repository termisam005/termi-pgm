...
import SongList10 from "../list/SongList10";


export default function LabelCopyAlbum() {
                                ...
                                <div className="aside_desc">
                                    <div className="m-t-5 m-b-20">
                                        <article className="hd_search">
                                            ...
                                            <input type="text" className="hd_input" placeholder="Search by Album Title" />
                                        </article>
                                    </div>
                                        ...
                                        <article className="contact_line">
                                            <div className="contact_sel">
                                                <div className="tab_line">
                                                    <p className="go">Song</p>
                                                    <p className="go on">Album</p>
                                                </div>
                                        ...
                                        <article className="list_zone">
                                            <div className="list_top">
                                                ...
                                                <div className="top_space w-19">
                                                    <span className="word">Label · Artist</span>
                                                </div>
                                                <div className="top_space w-16">
                                                    <span className="word">Genre · Language</span>
                                                </div>
                                                <div className="top_space w-20">
                                                    <span className="word">UPC · Purpose</span>
                                                </div>
                                            </div>
                                            <SongList10 txt_class="txt" label="JYP Entertatinment" artist="Stray Kids" genre="Genre" lang="English"
                                                upc="193483708676" purpose="Physical / Digital Release">
