...
export default function SongList7(props) {
    ...
    return (
        <section onMouseOver={hoverSong} onMouseLeave={outSong} className="the_list p-r-0">
                ...
                <dl className="message_dl songlist_dl">
                    ...
                    <dd>
                        <div className="mess_who">
                            <span className="list_who mid">ChEESE</span>
                        </div>
            ...
            <div className="list_space w-17">
                <ButtonWith class="btn_sm1 with f-s-13" spant="Remove" imgclass="m-r-5" src="../resources/images/trash_wh16.png" />
            </div>
        </section>
    );
}
