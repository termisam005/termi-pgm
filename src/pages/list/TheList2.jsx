...
export default function TheList2() {
                ...
                <dl className="message_dl">
                    ...
                    <dd>
                        <div className="mess_who">
                            <span className="list_who">TONO</span>
                        </div>
                        <div className="mess_tip">
                            <span className="word op07">Society</span>
                        </div>
                    </dd>
                </dl>
            </div>
            <div className="list_space dflx_jstart w-55">
                <p className="txt">Oslo, Norway</p>
            </div>
