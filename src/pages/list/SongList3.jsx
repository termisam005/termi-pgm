...
export default function SongList3(props) {
    ...
    return (
        <section onMouseOver={hoverSong} onMouseLeave={outSong} className="the_list">
            ...
            <div className="list_space w-16">
                <p className={songState ? "txt min" : "txt min hidd"}>
                    <span className="trash_vl14 m-r-5"></span>
                    <span className="cor913">Remove</span>
                </p>
