...
export default function SongInfoEval() {
    ...
    return (
        <article className="contain">
            <section className="contain_top">
                ...
                <div>
                    <ButtonComponent class="btn_sm1 cor w180" txt="Evaluation & Feedback" />
                </div>
            </section>
            <p className="line1"></p>
                        ...
                        <section className="contain_body">
                            <div className="comment_wrap">
                                <section className="comment_line">
                                    <CommentTab zone_class="comment_zone" />
                                </section>
                        ...
                        <section className="contain_body">
                            <div className="comment_wrap">
                                <section className="comment_line">
                                    ...
                                    <CommentTab zone_class="comment_zone h160" />
                                </section>
                                <section className="comment_exp">
